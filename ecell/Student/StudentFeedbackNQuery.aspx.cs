...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void btnPublish_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sessionLoggedInUserId = Session["LoggedInUserId"].ToString();
            string sqlUserEmail = "select email FROM tblStudentRegistration where id = " + sessionLoggedInUserId;
            ...
            DataTable tbl2 = dataSet.Tables["tblStudentRegistration"];
