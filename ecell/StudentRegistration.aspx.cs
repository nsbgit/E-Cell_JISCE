...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        TextBoxUniversityRoll.Text = string.Empty;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (lblDuplicateEmail.Text != "This email id is already registered with us.")
        {
            try
            {
                ...
                string sqlToInsert = "insert into tblStudentRegistration (firstName,lastName,email,pass,mobile,yr,department,section,university,doorNStreet,rlyStation,po,postalCode,district,state,status,dt) VALUES (@firstName,@lastName,@email,@pass,@mobile,@yr,@department,@section,@university,@doorNStreet,@rlyStation,@po,@postalCode,@district,@state,'Deactivated',getdate())";
                ...
                adapter.InsertCommand.Parameters.AddWithValue("@mobile", TextBoxMobile.Text);
                adapter.InsertCommand.Parameters.AddWithValue("@yr", DropDownListYear.Text);
                adapter.InsertCommand.Parameters.AddWithValue("@department", TextBoxDepartment.Text);
                adapter.InsertCommand.Parameters.AddWithValue("@section", TextBoxSection.Text);
                adapter.InsertCommand.Parameters.AddWithValue("@university", TextBoxUniversityRoll.Text);
                ...
                lblStatus.Text = "You have successfully registered. Your User ID and Password will be sent to your email address after aproval from admin";
    ...
    {
        string sqlToCheckDuplicateEmail = "select count(id) FROM tblStudentRegistration where email = @email";
